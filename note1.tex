...
\begin{enumerate}
    \item they are formulated in a tree-format that forces one to state all information that is used in an inference-step explicitly and thereby restricts the reliance on global features of a proof to a minimum (e.g. when checking that a disjunction of abnormalities is minimal);
