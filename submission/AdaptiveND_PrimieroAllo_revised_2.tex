...
\infer*[right=RC]{
    ...
    \end{mathpar}
    \caption{Redundancy of unconditional rules (basic case)}\label{fig:condasderived}
\end{figure}
...
{\TurnSeven {\Gamma, \Gamma'; \{\phi, \phi'\}^-} {\phi_{3}}}
    \end{mathpar}
    \caption{Redundancy of unconditional rules (general case)}\label{fig:condasderived}
\end{figure}
