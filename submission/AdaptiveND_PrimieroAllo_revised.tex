...
To preserve such information about retracted judgements within a proof, we need to extend the standard formalisation of proofs as trees, and define adaptive proofs as sequences of proof-trees.
